...
Давайте сразу опишем типы, которые будем использовать:
...
* Пользуемся прекрасным и неоднозначным принципом [SRP](https://stackify.com/solid-design-principles/), чтобы собрать необходимую логику воедино.
