...
Цель статьи - показать как можно решить проблему при написании юнит тестов, когда в коде есть зависимости на внешний ресурс (база данных/сеть/файловая система). Поэтому постарался сделать её более практической.
...
Представим, что необходимо протестировать функционал генерирования отчётов по активности пользователя.
