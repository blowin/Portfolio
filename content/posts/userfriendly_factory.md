...
Сталкивались ли вы с проблемой, когда у вас есть фабрика по созданию объектов, вы её создаётся в месте, где вам нужен объект и есть зависимости, которые в данном случае точно не нужны для создания вашего объекта и вы либо их проставляется в default/null?
...
* Непонятно, что мы проставляем в default. Т.е мы должны помнить какой параметр находится в какой позиции, а это проблематично, особенно, когда таких параметров много. ([named arguments](https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/classes-and-structs/named-and-optional-arguments) может улучшить ситуацию) 
